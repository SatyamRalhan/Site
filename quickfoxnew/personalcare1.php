					...
					<div class="row">
						...
						<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 pull-right">
							...
							<div class="shop-right-area mb-40-2 mb-30">
								<!-- tab-area-start -->
			<?php
                $query="SELECT * FROM items WHERE categories='Personal Care' LIMIT 0,12" ;
								...
								<div class="pagination-area">
									<div class="pagination-number">
										<ul>
											...
											<li><a href="personalcare2.php">2</a></li>
											<li><a href="personalcare2.php"><i class="fa fa-angle-right"></i></a></li>
										</ul>
									</div>
