					...
					<div class="row">
						...
						<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 pull-right">
							...
							<div class="shop-right-area mb-40-2 mb-30">
								<!-- tab-area-start -->
			<?php
                $query="SELECT * FROM items WHERE categories='Bakeries' LIMIT 24,12" ;
						 ...
						 ?>
								...
								<div class="pagination-area">
									<div class="pagination-number">
										<ul>
											<li><a href="bakeries2.php"><i class="fa fa-angle-left"></i></a></li>
											<li><a href="bakeries1.php">1</a></li>
											<li ><a href="bakeries2.php">2</a></li>
											<li class="active"><a href="#">3</a></li>
											<li><a href="bakeries4.php">4</a></li>
											<li><a href="bakeries4.php"><i class="fa fa-angle-right"></i></a></li>
										</ul>
									</div>
