                                                ...
                                                <ul class="mega-menu">
                                                    ...
                                                    <li>
                                                        <ul class="sub-menu-2">
                                                            ...
                                                            <li class="active"><a href="#">Personal Care</a></li>
					...
					<div class="row">
						...
						<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 pull-right">
							...
							<div class="shop-right-area mb-40-2 mb-30">
								<!-- tab-area-start -->
			<?php
                $query="SELECT * FROM items WHERE categories='Personal Care' LIMIT 12,12" ;
						 ...
						 ?>
								...
								<div class="pagination-area">
									<div class="pagination-number">
										<ul>
											<li><a href="personalcare1.php"><i class="fa fa-angle-left"></i></a></li>
											<li><a href="personalcare1.php">1</a></li>
