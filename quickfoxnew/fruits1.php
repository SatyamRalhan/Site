                                                ...
                                                <ul class="mega-menu">
                                                    ...
                                                    <li>
                                                        <ul class="sub-menu-2">
                                                            ...
                                                            <li class="active"><a href="#">Fruits & Veggies</a></li>
										...
										<ul id="nav">
											...
											<li><a href="shop.html">Men</a>
												<ul>
													...
													<li><a href="personalcare1.php">Personal Care</a></li>
													<li class="active"><a href="#">Fruits and Veggies </a></li>
					...
					<div class="row">
						...
						<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 pull-right">
							...
							<div class="shop-right-area mb-40-2 mb-30">
								<!-- tab-area-start -->
			<?php
                $query="SELECT * FROM items WHERE categories='Vegetables and Fruits' LIMIT 0,12" ;
